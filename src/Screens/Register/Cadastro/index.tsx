...
export function Register({
  ...
  const Cadastro = () => {
    let promise = sdk.account.create(
      "unique()",
      `${email}`,
      `${password}`,
      `${name}`
    ...
    promise.then(
      ...
      function (error) {
        console.log(error);
        console.log(
          "Não foi possível efetuar o cadastro, tente novamente ou aguarde um instante."
        );
      }
    );
  };
  ...
  return (
    <KeyboardAvoidingView style={styles.pai}>
      ...
      <View style={styles.container}>
        <Image source={Registro} style={styles.registerImage} />
