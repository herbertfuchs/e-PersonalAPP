...
import { View, Image, SafeAreaView, ScrollView, Text, Button, TouchableOpacity} from 'react-native';
...
export function VideoPlayer(){
    ...
    const handleModalThree = () => setIsModalVisibleThree(() => !isModalVisibleThree)
    // Terceiro PopUps
    const [isModalVisibleFour, setIsModalVisibleFour] = React.useState(false);
    const handleModalFour = () => setIsModalVisibleFour(() => !isModalVisibleFour)
    // Terceiro PopUps
    const [isModalVisibleFive, setIsModalVisibleFive] = React.useState(false);
    const handleModalFive = () => setIsModalVisibleFive(() => !isModalVisibleFive)
            ...
            <ScrollView style={styles.scroll}   >
                ...
                <Modal isVisible={isModalVisible}>
                    ...
                    <Modal.Container>
                        ...
                        <Modal.Body>
                        <Image 
                        source={{uri: "https://www.mundoboaforma.com.br/wp-content/uploads/2021/04/abdominal.gif"}}
                        style={styles.img}
                        />
                    ...
                    <Modal.Container>
                        ...
                        <Modal.Body>
                        <Image 
                        source={{uri: "https://www.mundoboaforma.com.br/wp-content/uploads/2020/11/agachamento-livre-1.gif"}}
                        style={styles.img}
                        />
                        <Text> 3 séries de 15 repitições cada!</Text>
                        </Modal.Body>
                    ...
                    <Modal.Container>
                        ...
                        <Modal.Body>
                        <Image 
                        source={{uri: "https://www.mundoboaforma.com.br/wp-content/uploads/2021/04/burpee.gif"}}
                        style={styles.img}
                        />
                        <Text> 3 séries de 15 repitições cada!</Text>
                        </Modal.Body>
                    ...
                    <Modal.Container>
                        ...
                        <Modal.Body>
                        <Image 
                        source={{uri: "https://www.mundoboaforma.com.br/wp-content/uploads/2021/04/pernas-afundo-tradicional-sem-pesos-1.gif"}}
                        style={styles.img}
                        />
                        <Text> 3 séries de 15 repitições cada!</Text>
                        </Modal.Body>
                    ...
                    <Modal.Container>
                        ...
                        <Modal.Body>
                        <Image 
                        source={{uri: "https://www.mundoboaforma.com.br/wp-content/uploads/2020/11/01431301-Bridge-straight-arm_Waist_360_logo.gif"}}
                        style={styles.img}
                        />
